...
public class BookingIntegrationTest {
    ...
    void paginationTest() throws Exception {
        ...
        assertThat(bookingList.get(0).getId(), equalTo(7));
        assertThat(bookingList.get(1).getId(), equalTo(6));
        assertThat(bookingList.get(2).getId(), equalTo(5));
        assertThat(bookingList.get(3).getId(), equalTo(4));
        assertThat(bookingList.get(4).getId(), equalTo(3));
        ...
        assertThat(bookingList.get(0).getId(), equalTo(2));
        assertThat(bookingList.get(1).getId(), equalTo(1));
        ...
        assertThat(bookingList.get(0).getId(), equalTo(3));
        assertThat(bookingList.get(1).getId(), equalTo(2));
        assertThat(bookingList.get(2).getId(), equalTo(1));
    }
    ...
    private Booking getBooking(int id, User booker, Item item, LocalDateTime start, LocalDateTime end) {
